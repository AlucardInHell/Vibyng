...
{activeTab === "live" && (
  <div className="h-[calc(100dvh-20rem)] sm:h-[calc(100dvh-18rem)] rounded-[28px] border border-border/60 bg-card flex flex-col items-center justify-center text-center px-6">
...
<div
  ...
  className={`${activeTab === "live" ? "hidden" : ""} h-[calc(100dvh-20rem)] sm:h-[calc(100dvh-18rem)] overflow-y-auto snap-y snap-mandatory`}
>
