import { pgTable, text, serial, integer, boolean, timestamp, decimal, numeric, unique } from "drizzle-orm/pg-core";
...
export const insertVideoSchema = createInsertSchema(artistVideos).omit({
  id: true,
  createdAt: true,
  likesCount: true,
});
